{
  ...
  ## NOTE: no extra tick marks, so did not put in argument to remove them ###
  plot5 = ggplot( data=weatherData ) +
    ...
    theme_bw(); ## put black and white theme before the x-axis theme
    theme( axis.text.x=element_text(angle=90, vjust=0.5, color = "blue", size = 2) ) +
  plot(plot5);
}